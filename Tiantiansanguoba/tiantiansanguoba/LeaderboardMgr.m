    ...
    [GKScore reportScores:scores withCompletionHandler:^(NSError *error) {
        if (error != nil) {
            [GKNotificationBanner showBannerWithTitle:nil
                                              message:[NSString stringWithFormat:@"report score:%lld to leaderboard encounter error:%@", score, error.description]
                                    completionHandler:nil];
        }else{
            [GKNotificationBanner showBannerWithTitle:nil
                                              message:[NSString stringWithFormat:@"report score:%lld to leaderboard", score]
                                    completionHandler:nil];
        }
